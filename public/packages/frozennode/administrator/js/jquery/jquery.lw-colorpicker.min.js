 ...
 */
(function () {
    var a = typeof WebKitCSSMatrix != "undefined" && (new WebKitCSSMatrix).m11, b = {start: "mousedown touchstart", move: "mousemove touchmove", end: "mouseup touchend"};
    ...
    var c = function (a) {
        ...
        var b = (a[0] - Math.floor(a[0])) * 6, c = b - Math.floor(b), d = a[2] * (1 - a[1]), e = a[2] * (1 - a[1] * c), f = a[2] * (1 - a[1] * (1 - c)), g = 0, h = 0, i = 0;
        switch (Math.floor(b)) {
            case 0:
        ...
        var b = a[0] / 255, c = a[1] / 255, d = a[2] / 255, e = Math.max(b, c, d), f = Math.min(b, c, d), g, h, i = e, j = e - f;
        h = e == 0 ? 0 : j / e;
        if (e == f)g = 0; else {
            switch (e) {
                case b:
    ...
    g.template = '<div class="lw-sb">    <img alt="" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAQAAAAABCAYAAAAxWXB3AAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAEFJREFUeNpi/A8EDAwMIMxAgCYkhs4mho9LjBg5euJ/FMj/o7EYpXxamPmPDuFAjbihJyY1nZOSl4jNoxg0QIABAI+56gCQgk6WAAAAAElFTkSuQmCC">    <img alt="" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAEACAYAAAByPhyYAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAEFJREFUeNpiYIACRiYQyUQci1gJbFySxPBLkKRkkBBM1FPHNEAS9BAbeIuoLUGTJDBICEpyKJnFA+mFEVYWQIABAG2AAvsKiLR6AAAAAElFTkSuQmCC">    <div class="lw-handle"></div>   </div>   <div class="lw-h">    <img alt="" src="data:image/png;base64,">    <div class="lw-handle"></div>   </div>', g.prototype.destroy = function () {
        ...
        var a = this.$el.find(".lw-sb"), b = this.$el.find(".lw-h"), c = this.getPosition(a.find(".lw-handle")), d = this.getPosition(b.find(".lw-handle"));
        ...
        this.setPosition(b.find(".lw-handle"), {top: Math.floor((1 - a[2]) * b.height()), left: Math.floor(a[1] * b.width())}), this.setPosition(d.find(".lw-handle"), {top: Math.floor((1 - a[0]) * d.height()), left: 0}), a[1] = a[2] = 1, this.$el.find(".lw-sb").css("background", "#" + c(e(a)))
