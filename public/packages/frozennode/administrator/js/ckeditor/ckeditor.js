...
(function () {
    ...
    CKEDITOR.config.plugins = 'dialogui,dialog,a11yhelp,basicstyles,blockquote,panel,floatpanel,menu,contextmenu,resize,button,toolbar,list,indent,enterkey,entities,popup,filebrowser,floatingspace,listblock,richcombo,format,htmlwriter,horizontalrule,wysiwygarea,image,fakeobjects,link,magicline,maximize,removeformat,sourcearea,specialchar,stylescombo,tab,table,tabletools,undo';
    CKEDITOR.config.skin = 'moono';
    (function () {
        var icons = ( 'bold,0,italic,32,strike,64,subscript,96,superscript,128,underline,160,blockquote,192,bulletedlist-rtl,224,bulletedlist,256,numberedlist-rtl,288,numberedlist,320,indent-rtl,352,indent,384,outdent-rtl,416,outdent,448,horizontalrule,480,image,512,anchor-rtl,544,anchor,576,link,608,unlink,640,maximize,672,removeformat,704,source-rtl,736,source,768,specialchar,800,table,832,redo-rtl,864,redo,896,undo-rtl,928,undo,960' ), path = CKEDITOR.getUrl('plugins/icons.png'), icons = icons.split(',');
