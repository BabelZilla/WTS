...
<div class="page-header">
    <h2>Reading language files for this extension <br>

        <p class="subheader"<b>Please be patient. The WTS will let you know when the process is finished.</b></p>
    </h2>
</div>
<br><br>
...
<div id="result">
    ...
    <p align="center" id="nextclick" style="display:none;"><br><b><a href='<?php echo route(
                'projectlist');?>' class='button radius'><i class='icon-white icon-ok'></i> Proceed with the next
                step</a></b></p>
</div>